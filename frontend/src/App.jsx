...
function App() {
  ...
  const addTask = async (newTask) => {
    try {
      const response = await axios.post('http://localhost:8085/insert-tasks', [newTask]);
  ...
  return (
    <div className='w-screen min-h-screen bg-slate-800 flex justify-center p-6'>
      <div className='w-[700px]'>
        <h1 className='text-3xl text-slate-100 font-bold text-center pb-5'>Gerenciador de Tarefas</h1>
